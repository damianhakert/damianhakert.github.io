...
title: Marketing Bootcamp Checklist
---
...
**Goal of this entire checklist:** Set a clear path for marketing team member training

### Stage 0 (GitLab Inc. only)

#### Goals

- Have all the needed user accounts and permissions for a GitLab Inc. marketer
...
1. [ ] Check back on your [Marketo?] account if you are not yet an `Agent`.
1. [ ] Check to make sure you were added to the `Events & Sponsorship` Google Calendar and can see it's events.
...
1. [ ] Ask as many questions as you can think of on the `#marketing` chat channel
