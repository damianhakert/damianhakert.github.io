...
* [ ] Hiring manager is (FILL IN WITH @ HANDLE) and People Ops is tackled by (FILL IN WITH @ HANDLE).
* [ ] Buddy is (FILL IN WITH @HANDLE (Nominate someone preferably in similar timezone but different functional group)): schedule a video call with the new team member.
