...
* For all external meetings include [visiting info](http://about.gitlab.com/visiting) (for in-person meetings), our [primer page](about.gitlab.com/primer), phone numbers, and where to find the Hangout URL. Make sure to add both a video call link (Hangout or Zoom) and physical phone numbers.
...
* Due to a busy schedule the CEO has a preference of meeting setup: First try for a video call, plan B would be a meeting at the GitLab office, and lastly the CEO will travel to another location for a meeting
