...
1. The call is recorded automatically, and recordings are automatically deleted after 7 days. Recordings can be found by logging in to BlueJeans, click recordings at the top, and all past recordings show up there. The recordings are private, i.e. only people who are able to log in to the GitLab BlueJeans account can view the recordings. 
