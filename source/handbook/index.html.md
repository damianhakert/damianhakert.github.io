...
1. The call is recorded automatically, and all calls are transferred every hour to a Google Drive folder called "GitLab Videos". There is a folder called "GitLab Team Call", which is accessible to all users with a GitLab.com e-mails account.
