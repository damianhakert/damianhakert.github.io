...
1. If you noticed GitLab tests being broken or false positive in the master branch then contribute to fixing it. Consider informing CTO if problem was not resolved during a day.  
