...
1. [ ] Hiring Manager: Announce in #general chat channel as soon as the chat and Google Accounts are blocked: 'As of today X is no longer with GitLab. Out of respect to their pricacy I can't go into details. If you have any questions that I might be able to answer please let me know.' It is very important to send this message as soon as possible so people know that they can rely on official communication channels and not have to find out through the grapefine. Delays in announcing it are not acceptable. The policy of not commenting on circumstances is in force indefinitely. If people press for answers say you don't want to suggest that underperformance was a reasons for this exit but remind them that it is stated in our general guidelines that job feedback is between an individual and their manager and that if managers do their job right any exit should come as a surprise to everyone except the individual and the manager.
...
1. [x] _not relevant_ New team member: Join the `#interaction` channel on Slack.
