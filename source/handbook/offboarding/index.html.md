...
1. [x] _not relevant_ New team member: Fill in your [profile](https://gitlab.com/profile): Organisation = "GitLab", Bio = "(title) at GitLab"
1. [x] _not relevant, already addressed_ New team member: [Add yourself](https://about.gitlab.com/handbook/general-onboarding/onboarding-101/#add-yourself-to-the-team-page) to the [team page](https://about.gitlab.com/team/)
