...
The 'Shared' vault (to which all team members have access) has a secure note for _each_ service that uses individual or OAuth account access. The note lists whom you should contact to gain access to the service.
