...
1. For technical roles, such as developer roles, we ask candidates to work on GitLab issues. Of course the candidate may propose another way of showing their skills.
1. Try to get a real sample of work. Avoid puzzles or weird algorithm testing questions. Probing for data structures is fine as long as it is relevant to the job the person is going to do.
