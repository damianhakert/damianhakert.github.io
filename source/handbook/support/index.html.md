...
As described in more detail in the [support listings](https://about.gitlab.com/support/) as well as the [support onboarding page](/handbook/support/onboarding/), we offer services beyond simply responding to tickets. More information on scheduling customer calls can be found on the [support knowledge base](https://about.gitlab.com/handbook/support/knowledge-base/categories/general/customer_calls.html).
