...
1. Emails sent to one person (no cc:) and likely not include other people later on don't need a subject line (make the first line descriptive since Gmail uses that). Please do include a subject line for non-gmail non-apple-mails users such as Ernst and Jacob Vosmaer.
