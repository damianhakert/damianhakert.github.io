...
- Writers choose one of the existing issues or create a new one in the
[Technical Articles issue tracker](https://gitlab.com/gl-docsteam/technical-articles/issues).
...
together with a writing sample, and the introduction of their article.
  ...
  - **Introduction**: write the abstract of your article (100-150 words). We'll evaluate your approach, writing style, organization, clearness, and conciseness.
...
- Based on them, the editor might approve or reprove the author to write.
- If approved, the author will have a green light to write the content and send us the first draft. In this
case, the editor will drop a line in the issue thread:
...
according to the [evaluation criteria](#evaluation-criteria).
- If we reject the content, we can give the author one chance to make it
better, or reject it entirely.
- If we accept the content, we will proceed to review.

#### 5. Review

- We will review the content and require the author to make the necessary changes, improvements, and adjustments.
- We will make the review as much brief and direct as possible. We expect the author to submit their draft ready to be published.
- Once the review is accomplished by the author, we will provide them with the compensation offer, according to the [compensation criteria](#compensation-criteria).
...
If the content gets out-of-date, we will ask the author to update it.
...
- GitLab reserves the right to refuse to publish the article at any time of the process.
