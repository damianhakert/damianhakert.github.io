...
GitLab helps you **collaborate on digital work** with others. We made many enhancements to issues, a core part of collaboration to GitLab. This includes weights ([8.3](/2015/12/22/gitlab-8-3-released)), linking to merge requests ([8.3](/2015/12/22/gitlab-8-3-released)), moving an issue to another project, and a powerful filter/search interface ([8.16](/2017/01/22/gitlab-8-16-released)). We also released issue boards in ([8.11](/2016/08/22/gitlab-8-11-released)), providing a simple mechanism to do issue workflow management using stages ("lists", in GitLab parlance). 9.0 continues to enhance boards further, [by improving its integration with milestones](#boards-with-milestones).
