...
If you are using GitLab on your Raspberry Pi, it works exactly the same way as it does regularly. You can use GitLab's official user documentation as a guide.